...
/***/ "./src/imports/GroupsManagementHandler.ts":
/*!************************************************!*\
  !*** ./src/imports/GroupsManagementHandler.ts ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ GroupsManagementHandler; }
/* harmony export */ });
...
class GroupsManagementHandler {
    static setup() {
        ...
        $("#btnRemindUsers").on('click', (ev) => {
            ev.preventDefault();
            const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/settings/sendReminder');
    ...
    updateGroupLists() {
        ...
        const newSendentGroups = Object.values(li).map(htmlElement => { var _a; return (_a = htmlElement.dataset) === null || _a === void 0 ? void 0 : _a.gid; }).filter(text => text !== undefined);
        // Update backend
        console.log('Updating backend with groups: ' + newSendentGroups);
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/settings/activeGroups');
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, { newSendentGroups });
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ LicenseHandler; }
/* harmony export */ });
/* harmony import */ var _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/axios */ "./node_modules/@nextcloud/axios/dist/index.js");
/* harmony import */ var _nextcloud_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/router */ "./node_modules/@nextcloud/router/dist/index.js");
...
class LicenseHandler {
    constructor() {
        $("#btnLicenseActivation").on('click', (ev) => {
            var _a, _b;
            ev.preventDefault();
            const email = ((_a = $("#licenseEmail").val()) === null || _a === void 0 ? void 0 : _a.toString().replace(/\s+/g, '')) || '';
            const key = ((_b = $("#licensekey").val()) === null || _b === void 0 ? void 0 : _b.toString().replace(/\s+/g, '')) || '';
        ...
        $("#licenseEmail, #licensekey").on('change', () => {
            $("#btnLicenseActivation").val((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendent", "Activate license"));
    ...
    createLicense(email, key) {
        return __awaiter(this, void 0, void 0, function* () {
            this.disableButtons();
            try {
                yield this.sendCreationRequest(email, key);
            }
            catch (err) {
    ...
    refreshLicenseStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { data: status } = yield this.requestStatus();
                ...
                $("#licensestatus").text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendent", "Cannot verify your license. Please make sure your licensekey and emailaddress are correct before you try to 'Activate license'."));
                $("#licenselastcheck").text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendent", "Just now"));
    ...
    updateButtonStatus(kind) {
        if (kind === 'valid') {
            $("#btnLicenseActivation")
                .removeClass("shown")
                .addClass("hidden")
                .val((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendent", "Activate license"));
        }
        else if (['check', 'expired', 'userlimit'].includes(kind)) {
            $("#btnLicenseActivation")
                .removeClass("hidden")
                .addClass("shown")
                .val((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendent", "Revalidate license"));
        }
        else {
            $("#btnLicenseActivation")
                .removeClass("hidden")
    ...
    deleteLicense() {
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/license');
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](url);
    }
    sendCreationRequest(email, license) {
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/license');
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, { email, license });
    }
    requestStatus() {
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/licensestatusinternal');
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url);
    }
    requestApplicationStatus() {
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/status');
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url);
    }
}
...
/***/ "./src/utils/consentFlowScript.js":
/*!****************************************!*\
  !*** ./src/utils/consentFlowScript.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "activateConsentFlowDialog": function() { return /* binding */ activateConsentFlowDialog; }
/* harmony export */ });
/* harmony import */ var _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/axios */ "./node_modules/@nextcloud/axios/dist/index.js");
/* harmony import */ var _nextcloud_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/router */ "./node_modules/@nextcloud/router/dist/index.js");
/* harmony import */ var _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @nextcloud/l10n */ "./node_modules/@nextcloud/l10n/dist/index.js");
...
function activateConsentFlowDialog() {
	$('#consentFlowButton').on('click', function(e) {
		console.log('Starting consent flow')
		$('#consentFlowButton').val((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendentsynchroniser", "Give access"))
		$('#consentFlowHeader').val("");
		$('#consentFlowTitle').text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendentsynchroniser", "Step 1: Set up appointments, contacts, and tasks"))
		$('#consentFlowText').text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendentsynchroniser", 'Please click the button below to sync your Outlook appointments, contacts, and tasks with Nextcloud.'))
		$('#consentFlowButton').off()
		$('#consentFlowButton').on('click', function(e) {
			console.log('Creating an app token to give synchroniser app access to nextcloud user data')
			var url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/user/activate');
			$('#consentFlowButton').off()
			_nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url).then( resp => {
				$('#consentFlowTitle').text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendentsynchroniser", "Step 2: Set up mail"))
				$('#consentFlowText').text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendentsynchroniser", 'Please click the button below to grant permission for accessing your Exchange mailbox.'))
				$('#consentFlowButton').off()
				$('#consentFlowButton').on('click', function(e) {
					console.log('Granting access to user Exchange mailbox')
					url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/user/activateMail');
					_nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url).then( resp => {
						$('#consentFlowButton').hide()
						$('#consentFlowTitle').text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendentsynchroniser", "Configuration complete"))
						$('#consentFlowText').text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)("sendentsynchroniser", 'Your account is fully configured for Exchange synchronization.'))
...
/* harmony import */ var _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/axios */ "./node_modules/@nextcloud/axios/dist/index.js");
/* harmony import */ var _nextcloud_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/router */ "./node_modules/@nextcloud/router/dist/index.js");
/* harmony import */ var _imports_GroupsManagementHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./imports/GroupsManagementHandler */ "./src/imports/GroupsManagementHandler.ts");
/* harmony import */ var _imports_LicenseHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./imports/LicenseHandler */ "./src/imports/LicenseHandler.ts");
/* harmony import */ var _utils_consentFlowScript_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/consentFlowScript.js */ "./src/utils/consentFlowScript.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* eslint-disable @nextcloud/no-deprecations */
...
$(() => {
    ...
    if ($("#groupsManagement").length) {
        // Admin settings page
        _imports_LicenseHandler__WEBPACK_IMPORTED_MODULE_3__["default"].setup();
        _imports_GroupsManagementHandler__WEBPACK_IMPORTED_MODULE_2__["default"].setup();
        $('#setReminderType').on('change', function (e) {
            const reminderType = e.target.value;
            const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/settings/reminderType');
            _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, { reminderType }).then((resp) => {
        ...
        $('#setNotificationMethod').on('change', function (e) {
            const notificationMethod = e.target.value;
            const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/settings/notificationMethod');
            _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, { notificationMethod }).then((resp) => {
                if (resp.status === 200 && resp.data) {
        ...
        $('#setNotificationInterval').on('change', function (e) {
            const notificationInterval = e.target.value;
            const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/settings/notificationInterval');
            _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, { notificationInterval }).then((resp) => {
                if (resp.status === 200 && resp.data) {
        ...
        $('#setSharedSecret').on('keyup', function (e) {
            ...
            $(this).data('timer', setTimeout(function () {
                const sharedSecret = $('#setSharedSecret')[0].value;
                if (sharedSecret !== '') {
                    const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/settings/sharedSecret');
                    _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, { sharedSecret }).then((resp) => {
                        if (resp.status === 200 && resp.data) {
        ...
        $('#showSharedSecret').on('mousedown', function (e) {
            $('#setSharedSecret')[0].type = "text";
        }).on('mouseup', function (e) {
            $('#setSharedSecret')[0].type = "password";
        });
        ...
        (0,_utils_consentFlowScript_js__WEBPACK_IMPORTED_MODULE_4__.activateConsentFlowDialog)();
        $('#retractConsentButton').on('click', function (e) {
            const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendentsynchroniser/api/1.0/user/invalidate');
            _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url).then(() => {
                // TODO handle error
                location.reload();
            });
        });
