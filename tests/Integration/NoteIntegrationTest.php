...
namespace OCA\SendentSynchroniser\Tests\Integration\Controller;

use OCP\AppFramework\App;
use OCP\IRequest;
use PHPUnit\Framework\TestCase;

use OCA\SendentSynchroniser\Db\Note;
use OCA\SendentSynchroniser\Db\NoteMapper;
use OCA\SendentSynchroniser\Controller\NoteController;
...
class NoteIntegrationTest extends TestCase {
	...
	public function setUp(): void {
		$app = new App('sendentsynchroniser');
